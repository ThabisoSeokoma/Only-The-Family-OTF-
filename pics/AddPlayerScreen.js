...
const AddPlayerScreen = () => {
  ...
  //  console.log("mentally " , Data);
    ...
    const selectedPlayerUid = selectedPlayer.id;

    // Define the data you want to save (including the player UID)
    const playerData = {
      uid: selectedPlayerUid, // Add the player UID to the data
      name: selectedPlayer.name,
      surname: selectedPlayer.surname,
    };
